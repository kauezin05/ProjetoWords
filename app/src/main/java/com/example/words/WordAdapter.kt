...
class WordAdapter(private val letterId: String, context: Context) :
    ...
    init {
        ...
        filteredWords = words
            ...
            .filter { it.startsWith(letterId, ignoreCase = true) } //pegar todos que começam com a mesma letra e ignorar a case
            // Returns a collection that it has shuffled in place
            .shuffled() // embaralha as palavras
            // Returns the first n items as a [List]
            .take(5)// pega 5 palavras
